...
class Create_afr(unittest.TestCase):
    def setUp(self):
	self.driver = common.browers()
        self.driver.implicitly_wait(30)
        self.base_url = common.baseurl()
	self.nodes=common.node_num()
        self.verificationErrors = []
        self.accept_next_alert = True
    
    def test_create_afr(self):
        driver = self.driver
	...
	#选择服务类型
	Select(driver.find_element_by_id("serviceraidlv")).select_by_visible_text(u"冗余")
	driver.find_element_by_id("clusterserviceafrnum").send_keys(self.nodes)	
        driver.find_element_by_id("btnext").click()
